 ...
 * Available backends
 */
typedef enum argonautica_backend_t {
  /**
   * The C backend
   */
  ARGONAUTICA_C = 0,
 ...
 * Argonautica errors
 */
typedef enum argonautica_error_t {
  /**
 ...
 */
typedef enum argonautica_variant_t {
  /**
   * argon2d
   */
 ...
 */
typedef enum argonautica_version_t {
  /**
   * 0x10
   */
  ARGONAUTICA_0x10 = 13,
 ...
 */
const char *argonautica_error_msg(enum argonautica_error_t err);
 ...
 */
enum argonautica_error_t argonautica_hash(char *encoded,
                                          ...
                                          enum argonautica_backend_t backend,
                                          uint32_t hash_len,
                                          uint32_t iterations,
                                          uint32_t lanes,
                                          ...
                                          uint32_t threads,
                                          enum argonautica_variant_t variant,
                                          enum argonautica_version_t version);
 ...
 * `argonautica_hash`
 */
enum argonautica_error_t argonautica_verify(int *is_valid,
                                            const uint8_t *additional_data,
                                            uint32_t additional_data_len,
                                            const char *encoded,
                                            uint8_t *password,
