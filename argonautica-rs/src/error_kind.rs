...
pub enum ErrorKind {
    ...
    #[error("Memory size too small. Memory size must be at least 8 times the number of lanes")]
    ...
    #[error("Version encode error. &str or u32 provided could not be encoded into a Version")]
    VersionEncodeError,
